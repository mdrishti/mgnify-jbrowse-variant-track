...
exports.buildDefaultSessionConfig =
  exports.buildTracksConfig =
  exports.buildAssemblyConfig =
    void 0;
...
function buildTracksConfig(props, opts) {
  ...
  const adapterMode =
    (_b =
      (_a = opts === null || opts === void 0 ? void 0 : opts.adapterMode) !==
        null && _a !== void 0
        ? _a
        : gff.gffAdapterMode) !== null && _b !== void 0
      ? _b
      : "auto";
  ...
  const showEssentiality = !!(essentiality === null || essentiality === void 0
    ? void 0
    : essentiality.enabled);
  ...
  const essentialityFields = {
    essentialityCsvUrl:
      showEssentiality &&
      (essentiality === null || essentiality === void 0
        ? void 0
        : essentiality.csvUrl)
        ? essentiality.csvUrl
        : "",
    csvJoinColumn:
      (_c =
        essentiality === null || essentiality === void 0
          ? void 0
          : essentiality.csvJoinColumn) !== null && _c !== void 0
        ? _c
        : "locus_tag",
    csvStatusColumn:
      (_d =
        essentiality === null || essentiality === void 0
          ? void 0
          : essentiality.csvStatusColumn) !== null && _d !== void 0
        ? _d
        : "essentiality",
    featureJoinAttribute:
      (_e =
        essentiality === null || essentiality === void 0
          ? void 0
          : essentiality.featureJoinAttribute) !== null && _e !== void 0
        ? _e
        : "locus_tag",
  };
  ...
  const tracks = [];
  if (
    ((_f = props.variants) === null || _f === void 0 ? void 0 : _f.vcfUrl) &&
    ((_g = props.variants) === null || _g === void 0 ? void 0 : _g.tbiUrl)
  ) {
    tracks.push({
      type: "VariantTrack",
      trackId: "variants",
      name:
        (_h = props.variants.name) !== null && _h !== void 0 ? _h : "Variants",
...
function buildDefaultSessionConfig(opts) {
  ...
  sessionTracks.push({
    id:
      (_b =
        geneTrack === null || geneTrack === void 0
          ? void 0
          : geneTrack.trackId) !== null && _b !== void 0
        ? _b
        : "gene_features",
    type: "FeatureTrack",
    configuration:
      (_c =
        geneTrack === null || geneTrack === void 0
          ? void 0
          : geneTrack.trackId) !== null && _c !== void 0
        ? _c
        : "gene_features",
    minimized: false,
    visible: true,
    displays:
      (_d =
        geneTrack === null || geneTrack === void 0
          ? void 0
          : geneTrack.displays) !== null && _d !== void 0
        ? _d
        : [
            {
              displayId: "gene_features-LinearBasicDisplay",
