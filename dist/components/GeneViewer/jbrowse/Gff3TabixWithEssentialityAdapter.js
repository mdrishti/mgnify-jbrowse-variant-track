...
const Gff3TabixAdapter_1 = __importDefault(
  require("@jbrowse/plugin-gff3/esm/Gff3TabixAdapter/Gff3TabixAdapter"),
);
const configSchema_1 = __importDefault(
  require("@jbrowse/plugin-gff3/esm/Gff3TabixAdapter/configSchema"),
);
