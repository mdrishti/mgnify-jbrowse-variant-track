...
function FeatureDetails({ f, essentiality }) {
  ...
  return (0, jsx_runtime_1.jsxs)("div", {
    style: {
      paddingLeft: 8,
      borderLeft: `2px solid ${constants_1.COLORS.border}`,
      marginBottom: 12,
    },
    children: [
  ...
  return (0, jsx_runtime_1.jsxs)("div", {
    ...
    children: [
      ...
      expanded &&
        (0, jsx_runtime_1.jsx)("div", {
          style: { marginTop: 6 },
          children: (0, jsx_runtime_1.jsx)(FeatureDetails, {
            f: feature,
            essentiality: null,
          }),
        }),
...
function FeaturePanel(props) {
  ...
  const [expandedIndices, setExpandedIndices] = (0, react_1.useState)(
    () => new Set(),
  );
  const toggleIndex = (i) => {
  ...
  if (features.length === 1) {
    return (0, jsx_runtime_1.jsxs)("div", {
      ...
      children: [
        ...
        (0, jsx_runtime_1.jsx)(FeatureDetails, {
          f: features[0],
  ...
  return (0, jsx_runtime_1.jsxs)("div", {
    ...
    children: [
      ...
      (0, jsx_runtime_1.jsx)(Field, { label: "Gene", children: locusTag }),
      (0, jsx_runtime_1.jsx)(Field, {
        label: "CDS count",
